...
\begin{enumerate}
  ...
  \item Isothermal expansion (PO): The gas is now at the same temperature as the cold reservoir. As the gas expands under constant temperature, it absorbs heat from the cold reservoir to maintain the temperature. \hl{Heat is absorbed from the cold reservoir}.
