...
\begin{quote}
  A vertical rectangular loop of conducting wire is dropped in a region of horizontal magnetic
  field. The diagram shows the loop as it leaves the region of the magnetic field. Just before the loop is about to completely exit the region of magnetic field, the loop moves with constant terminal speed $v$.
  The following data is available; find $v$.
\end{quote}
\begin{table}[H]
  \centering
  \begin{tabular}{|c|c|}
