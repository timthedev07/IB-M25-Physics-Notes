...
\subsection{MCQ \#8 -- Pulley (1)}

Three identical masses are connected as shown with a string that passes over an ideal pulley. The tension in the string connecting $m_1$ and $m_2$ is $T$. The tension of the string attached to $m_3$ is $T_2$.

\img{ex/13.png}{0.3}{Pulley system}{pulley2}

We will take the universal approach here by drawing the free body diagrams for all three masses.
...
\begin{minipage}{0.3\textwidth}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
      ...
      % Upward force (T1)
      \draw[->, thick] (0,0.5) -- (0,2) node[midway, right] {\( T_1 \)};

      % Downward force (m1g)
      \draw[->, thick] (0,-0.5) -- (0,-3) node[midway, right] {\( m g \)};
    \end{tikzpicture}
  \end{figure}
\end{minipage}%
...
\begin{minipage}{0.3\textwidth}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
      ...
      % Upward force (T1)
      \draw[->, thick] (0,0.5) -- (0,2) node[midway, right] {\( T_2 \)};

      % Downward force (m2g)
      \draw[->, thick] (0,-0.5) -- (0,-3) node[midway, right] {\( T_1 + mg \)};
...
\begin{minipage}{0.3\textwidth}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
      ...
      % Upward force (T2)
      \draw[->, thick] (0,0.5) -- (0,2.5) node[midway, right] {\( T_2 \)};

      % Downward force (m3g)
      \draw[->, thick] (0,-0.5) -- (0,-2) node[midway, right] {\( mg \)};
